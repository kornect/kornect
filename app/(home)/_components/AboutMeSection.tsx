...
const AboutMeSection = () => {
    return (
        <div id="about" className="relative overflow-hidden mb-10">
            <div
                className="grid md:grid-cols-2 gap-8 md:gap-12 items-start p-6 md:p-10 z-10 bg-white dark:bg-gray-900 max-w-7xl mx-auto border dark:border-gray-700 shadow-lg rounded">
                <div>
                    <h2 className="text-2xl md:text-3xl font-bold mb-4 font-poppins">About Me</h2>
                ...
                <div className="p-5 md:p-6 rounded relative bg-gray-50 dark:bg-gray-800">
                    ...
                    <Link
                        href="#contact"
                        className="inline-block w-full text-center sm:w-auto mt-2 px-5 py-3 bg-black text-white dark:bg-yellow-300 dark:text-black rounded hover:bg-gray-800 dark:hover:bg-yellow-400 transition"
                    >
